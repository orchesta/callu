...
public interface INotificationQueryService
{
    ...
    /// <summary>Hide a notification from the user's inbox (sets InboxDismissedAt) — a per-user cosmetic action,
    /// NOT a soft-delete, and invisible to the dispatch pipeline, so it cannot cancel a page in flight.</summary>
