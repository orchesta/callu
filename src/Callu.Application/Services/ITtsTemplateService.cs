...
public interface ITtsTemplateService
{
    ...
    /// <summary>
    /// Resolve messages for a given language code, with the language they turned out to be in.
    /// Returns merged dict: language-specific messages + English fallback defaults.
    /// </summary>
    Task<TtsResolvedMessages> ResolveMessagesAsync(string languageCode, CancellationToken ct = default);
