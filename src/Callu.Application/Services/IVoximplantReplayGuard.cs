...
/// <summary>Replay protection for VoxEngine callbacks: rejects a (timestamp, nonce) pair seen twice inside
/// <see cref="WindowSeconds"/>. Callers must also reject timestamps outside that window.</summary>
