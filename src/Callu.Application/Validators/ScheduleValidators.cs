...
/// <summary>Partial-patch body validator for the override update endpoint; every rule is gated on "field
/// supplied", and the service re-checks the merged bounds inside the update transaction.</summary>
