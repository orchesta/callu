...
/// <summary>
/// Automation rule whose actions run when a newly created incident matches its conditions.
/// Rules are evaluated in priority order; an update to an existing incident does not re-evaluate them.
/// </summary>
