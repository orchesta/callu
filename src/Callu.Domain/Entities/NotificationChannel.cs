...
public class NotificationChannel : BaseEntity
{
    ...
    /// <summary>Fire when an incident is closed. Defaults off (backward compatible).</summary>
    public bool NotifyOnIncidentClosed { get; set; }

    /// <summary>Fire when an incident is reopened. Defaults off (backward compatible).</summary>
