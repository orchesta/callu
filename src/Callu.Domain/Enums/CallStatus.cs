...
public enum CallStatus
{
    ...
    /// <summary>The call was answered but no key was ever pressed, and the prompts ran out</summary>
    SilenceTimeout = 9,

    /// <summary>Responder asked to be bridged in; no conference exists yet</summary>
    ConferenceRequested = 10
}
