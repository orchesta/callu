        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstSequence = table.Column<long>(type: "bigint", nullable: true),
                    LastSequence = table.Column<long>(type: "bigint", nullable: true),
                    FirstCreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastCreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditArchiveRuns", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AuditChainStates",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProtectedKey = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false),
                    ...
                    PrunedThroughSequence = table.Column<long>(type: "bigint", nullable: false),
                    PrunedThroughHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    UpdatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditChainStates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeBefore = table.Column<string>(type: "text", nullable: true),
                    ChangeAfter = table.Column<string>(type: "text", nullable: true),
                    ...
                    RequestRoute = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    RowHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    UpdatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceAccountJson = table.Column<string>(type: "character varying(32000)", maxLength: 32000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_FirebaseSettings_Singleton", "\"Id\" = '00000000-0000-0000-0000-000000000003'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifyOnIncidentClosed = table.Column<bool>(type: "boolean", nullable: false),
                    NotifyOnIncidentReopened = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    UpdatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ExhaustionBehavior = table.Column<int>(type: "integer", nullable: false),
                    MaxRepeatCycles = table.Column<int>(type: "integer", nullable: false),
                    MaxRepeatDurationMinutes = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    UpdatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timezone = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    NeedsRematerializeSince = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    UpdatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnershipDays = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Integrations_WebhookTemplates_WebhookTemplateId",
                        column: x => x.WebhookTemplateId,
                        principalTable: "WebhookTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EscalationCyclesCompleted = table.Column<int>(type: "integer", nullable: false),
                    IsNotificationSuppressed = table.Column<bool>(type: "boolean", nullable: false),
                    IsPagingSuppressed = table.Column<bool>(type: "boolean", nullable: false),
                    EscalationStagedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DispatchFailingSince = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextRetryAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DialOutFailingSince = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DialOutFailureKind = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    UpdatedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EscalationStepId = table.Column<Guid>(type: "uuid", nullable: true),
                    Title = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InboxDismissedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditArchiveRuns_Day",
                table: "AuditArchiveRuns",
                column: "Day",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                filter: "\"Sequence\" IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_EventName",
                table: "AuditLogs",
                column: "EventName");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallLogs_AttemptId",
                table: "CallLogs",
                column: "AttemptId",
                filter: "\"AttemptId\" IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_CallLogs_CallToken",
                table: "CallLogs",
                column: "CallToken",
                unique: true,
                filter: "\"CallToken\" IS NOT NULL AND \"IsDeleted\" = false");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CapabilityProviderMappings_Capability",
                table: "CapabilityProviderMappings",
                column: "Capability",
                unique: true,
                filter: "\"IsEnabled\" AND \"IsDeleted\" = false");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EscalationPolicies_TeamId_Active",
                table: "EscalationPolicies",
                column: "TeamId",
                unique: true,
                filter: "\"IsActive\" AND \"IsDeleted\" = false");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InboxEntries_CreatedAt",
                table: "InboxEntries",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_InboxEntries_Status_NextAttemptAt",
                table: "InboxEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incidents_ServiceId_ExternalAlertId",
                table: "Incidents",
                columns: new[] { "ServiceId", "ExternalAlertId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Integrations_WebhookTemplateId",
                table: "Integrations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationChannelDeliveries_ChannelId_AttemptedAt",
                table: "NotificationChannelDeliveries",
                columns: new[] { "ChannelId", "AttemptedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutboxEntries_SentAt",
                table: "OutboxEntries",
                column: "SentAt");

            migrationBuilder.CreateIndex(
                name: "IX_OutboxEntries_Status_NextAttemptAt_CreatedAt",
                table: "OutboxEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPushDevices_PushToken",
