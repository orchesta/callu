...
/// <summary>Rotation repository; rotations are templates, so "who is on call now?" belongs to
/// <c>IOnCallService</c> reading materialized occurrences instead.</summary>
