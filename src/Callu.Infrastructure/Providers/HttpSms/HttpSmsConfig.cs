...
/// <summary>Configuration for the generic HTTP SMS provider; property names must match the camelCase
/// keys the frontend writes, because deserialization here is case-sensitive.</summary>
