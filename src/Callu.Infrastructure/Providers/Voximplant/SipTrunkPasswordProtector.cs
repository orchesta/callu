...
/// <summary>Encrypts the long-lived SIP trunk password at rest, under a purpose distinct from
/// <see cref="VoxSipPasswordProtector"/>'s per-call copy; both hosts must share one keyring.</summary>
