...
internal static partial class EscalationOrchestratorLog
{
    ...
    [LoggerMessage(Level = LogLevel.Information, Message = "Escalation for incident {IncidentId} has no step left but a call is still ringing - holding the exhausted record until it settles")]
    public static partial void EscalationWaitingOnInFlightPage(ILogger logger, Guid incidentId);
