...
/// <summary>IANA timezone service backed by NodaTime's tzdb.</summary>
// Windows TimeZoneInfo is deliberately not used: its Windows-only ids do not resolve inside a Linux container, and scheduling
// already depends on IANA ids everywhere else.
