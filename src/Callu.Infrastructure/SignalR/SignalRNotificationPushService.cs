...
/// <summary>SignalR implementation of INotificationPushService, resolvable from both hosts.</summary>
public class SignalRNotificationPushService(
    IHubContext<NotificationHub> hubContext,
    ILogger<SignalRNotificationPushService> logger)
    : INotificationPushService
{
    /// <summary>Pushes one notification to a user's hub group, rethrowing so the caller can record the
    /// outcome; success here is not a delivery receipt, because an empty group also succeeds.</summary>
