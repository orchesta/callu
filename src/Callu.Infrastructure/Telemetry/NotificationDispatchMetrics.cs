...
internal static class NotificationDispatchMetrics
{
    ...
    /// <summary>Maps a failed notification to a small bounded failure category for use as a metric tag;
    /// the raw <see cref="Notification.ErrorMessage"/> must never become a metric label.</summary>
