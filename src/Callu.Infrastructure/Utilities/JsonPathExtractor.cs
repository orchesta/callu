...
{
    /// <summary>Extracts a value from a JSON document using a JSONPath expression.</summary>
    ...
    /// <summary>Extracts multiple values from one document using a field-to-JSONPath mapping.</summary>
