...
public static class AppConstants
{
    ...
    public static class TeamMemberRole
    {
        ...
        /// <summary>Case-insensitive role validation, because clients send lowercase and storage is canonical.</summary>
    ...
    /// <summary>Team color options for UI, stored as a 6-character hex code so every surface renders the same value.</summary>
