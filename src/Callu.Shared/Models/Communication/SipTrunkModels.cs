...
/// <summary>An edit to a SIP trunk; an omitted optional field keeps what is stored, and an empty one clears it.</summary>
// Name, Server, Username and Port are required by the validator, so an omitted one is a 400 rather
// than a silent wipe. The rest are null when the caller said nothing about them.
