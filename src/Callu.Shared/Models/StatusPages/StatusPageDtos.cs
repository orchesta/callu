...
/// <summary>Component DTO trimmed for public consumption; internal probe configuration is deliberately absent.</summary>
...
/// <summary>Public status-page DTO returned by the anonymous slug endpoint, with the trimmed component shape.</summary>
...
/// <summary>30-day uptime history for a single component — page-level and day-granular, not an SLA-grade measurement.</summary>
