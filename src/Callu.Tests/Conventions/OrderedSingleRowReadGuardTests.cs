...
public class OrderedSingleRowReadGuardTests
{
    ...
    [
        ...
        new("AuthService.cs", ", request.Email, httpContextAccessor.HttpContext?.Connection.RemoteIpAddress, httpContextAccessor.HttpContext?.Request.Headers.UserAgent.FirstOrDefault()", Verdict.InMemory),
        new("AuthService.cs", ", user.Email, httpContextAccessor.HttpContext?.Connection.RemoteIpAddress, httpContextAccessor.HttpContext?.Request.Headers.UserAgent.FirstOrDefault()", Verdict.InMemory),
