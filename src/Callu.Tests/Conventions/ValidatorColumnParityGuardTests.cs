...
public class ValidatorColumnParityGuardTests
{
    ...
    [
        ...
        new("UpdateServiceRequest", "AckContentType", PersistedTail),
        new("UpdateServiceRequest", "AckHeaders", PersistedTail),
        new("UpdateServiceRequest", "AckHttpMethod", PersistedTail),
        new("UpdateServiceRequest", "AckPayloadTemplate", PersistedTail),
        new("UpdateServiceRequest", "AckUrl", PersistedTail),
