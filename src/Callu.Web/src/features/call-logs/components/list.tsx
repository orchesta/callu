          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger id={`${formId}-status`} className="bg-input-background">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-5 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-lg bg-surface-light/20">
                  ...
                  <p style={{ fontSize: "0.9375rem", fontWeight: 600 }}>
                    {new Date(selectedLog.initiatedAt).toLocaleString(dateLocale(), {
                      month: "short",
                      day: "numeric",
                      year: "numeric",
                      hour: "2-digit",
                ...
                {selectedLog.completedAt && (
                  <div className="p-4 rounded-lg bg-surface-light/20">
                    ...
                    <p style={{ fontSize: "0.9375rem", fontWeight: 600 }}>
                      {new Date(selectedLog.completedAt).toLocaleString(dateLocale(), {
                        month: "short",
                        day: "numeric",
                        year: "numeric",
                        hour: "2-digit",
