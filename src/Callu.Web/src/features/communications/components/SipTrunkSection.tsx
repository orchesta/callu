        ...
        try {
            if (editingSip) {
                await updateSipTrunkMutation.mutateAsync({
                    ...
                    isEnabled: editingSip.isEnabled,
                });
                        ...
                        {sipTrunks.map((trunk) => (
                            ...
                            >
                                ...
                                <div className="flex gap-2">
                                    <Button size="sm" variant="ghost" aria-label={t("common.edit")} onClick={() => handleEdit(trunk)}>
                ...
                <DialogContent className="bg-card border-border sm:max-w-[600px]">
                    ...
                    <div className="space-y-5 py-4">
                        ...
                        <div>
                            ...
                            <Input
                                placeholder={t("sipTrunk.authUserPlaceholder")}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label htmlFor={`${formId}-transport`} style={{ fontSize: "0.875rem", fontWeight: 600, marginBottom: "0.5rem", display: "block" }}>
                                ...
                                >
                                    <SelectTrigger id={`${formId}-transport`} className="bg-input-background">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
