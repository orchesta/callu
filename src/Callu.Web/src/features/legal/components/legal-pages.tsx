...
/** Legal pages for the self-hosted distribution: the operator is the data controller and the upstream
 * project has no operational relationship to the instance. Informational only, not legal advice. */
