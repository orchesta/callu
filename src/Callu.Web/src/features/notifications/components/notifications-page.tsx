...
import { resolveActionUrl } from '@/shared/utils';
...
export function NotificationsPage() {
  ...
  const [deleting, setDeleting] = useState<NotificationItemDto | null>(null);
    ...
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/profile?section=notifications">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {notification.actionUrl && (
                        <Link to={resolveActionUrl(notification.actionUrl)}>
                      ...
                      <Button
                        ...
                        title={t("notifications.deleteAction")}
      ...
      <DeleteConfirmDialog
        ...
        message={t("notifications.deleteMsg", { title: deleting?.title ?? "" })}
        warning={t("notifications.deleteWarn")}
