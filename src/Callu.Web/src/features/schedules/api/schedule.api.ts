...
export const scheduleApi = {
    ...
    /** Settings + the whole rotation list in one atomic request. See SaveSchedulePlanRequest. */
    savePlan: (id: string, data: SaveSchedulePlanRequest) =>
        apiClient.put<void>(`${BASE}/${id}/plan`, data),
    ...
    getCoverage: (scheduleId: string, days = 30) =>
        apiClient.get<RotationCoverageResult>(`${BASE}/${scheduleId}/coverage?days=${days}`),
};
