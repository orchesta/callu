...
import { localDateTimeToUtcInstant, todayInZone } from "@/shared/lib/timezone";
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  ...
                  <div className="p-3 rounded-lg bg-surface-light/20">
                    ...
                    <p style={{ fontSize: "0.9375rem", fontWeight: 600 }}>
                      {new Date(schedule.createdAt).toLocaleDateString(dateLocale())}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-2 pt-4 border-t border-border">
                  ...
                  <Button
                    ...
                    aria-label={t("schedules.deleteAria").replace("{name}", schedule.name)}
        ...
        <DialogContent className="bg-card border-border sm:max-w-[600px]">
          ...
          <div className="space-y-5 py-4">
            ...
            <div>
              ...
              >
                <SelectTrigger id={`${formId}-override-user`} className="bg-input-background">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  min={selectedSchedule ? todayInZone(selectedSchedule.timezone) : undefined}
                />
              </div>
              <div>
                <label
            ...
            <div>
              <label
                htmlFor={`${formId}-override-duration`}
                style={{
                  fontSize: "0.875rem",
                  fontWeight: 600,
                  marginBottom: "0.5rem",
              ...
              >
                <SelectTrigger id={`${formId}-override-duration`} className="bg-input-background">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
