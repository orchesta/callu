        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="p-6 bg-card/80 backdrop-blur-sm border-border">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor={`${formId}-tts-language`} style={{ fontSize: '0.875rem', fontWeight: 600, marginBottom: '0.5rem', display: 'block' }}>
                  {t("webhookTemplate.labelTtsLanguage")}
                </label>
                <Select value={dataLanguage} onValueChange={setDataLanguage}>
                  <SelectTrigger id={`${formId}-tts-language`} className="bg-input-background">
        ...
        <div className="lg:col-span-3 space-y-6">
            ...
            <div className="space-y-5">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor={`${formId}-map-title`} style={{ fontSize: '0.875rem', fontWeight: 600 }}>
                ...
                {isManualTitle || parsedFields.length === 0 ? (
                  ...
                  <Select value={titleMapping} onValueChange={setTitleMapping}>
                    <SelectTrigger id={`${formId}-map-title`} className="bg-input-background font-mono text-sm">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor={`${formId}-map-description`} style={{ fontSize: '0.875rem', fontWeight: 600 }}>
                ...
                {isManualDescription || parsedFields.length === 0 ? (
                  ...
                  <Select value={descriptionMapping} onValueChange={setDescriptionMapping}>
                    <SelectTrigger id={`${formId}-map-description`} className="bg-input-background font-mono text-sm">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      {parsedFields.map((field) => (
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label htmlFor={`${formId}-map-severity`} style={{ fontSize: '0.875rem', fontWeight: 600 }}>
                  ...
                  {isManualSeverity || parsedFields.length === 0 ? (
                    ...
                    <Select value={severityFieldMapping} onValueChange={setSeverityFieldMapping}>
                      <SelectTrigger id={`${formId}-map-severity`} className="bg-input-background font-mono text-sm">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        {parsedFields.map((field) => (
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label htmlFor={`${formId}-map-external-id`} style={{ fontSize: '0.875rem', fontWeight: 600 }}>
                  ...
                  {isManualExternalId || parsedFields.length === 0 ? (
                    ...
                    <Select value={externalIdMapping} onValueChange={setExternalIdMapping}>
                      <SelectTrigger id={`${formId}-map-external-id`} className="bg-input-background font-mono text-sm">
          ...
          <Card className="p-6 bg-card/80 backdrop-blur-sm border-border">
            ...
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor={`${formId}-map-state`} style={{ fontSize: '0.875rem', fontWeight: 600 }}>
                ...
                {isManualState || parsedFields.length === 0 ? (
                  ...
                  <Select value={stateFieldMapping} onValueChange={setStateFieldMapping}>
                    <SelectTrigger id={`${formId}-map-state`} className="bg-input-background font-mono text-sm">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      {parsedFields.map((field) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    >
                      <SelectTrigger
                        className="bg-input-background"
                        aria-label={`${t("incidents.severity")}${mapping.sourceValue ? ` \u2014 ${mapping.sourceValue}` : ""}`}
                      >
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
