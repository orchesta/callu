...
/** Read-only inventory of the per-service webhook API keys. Creation and rotation stay on the service
 * detail page, so there is only one place the plaintext is ever shown. */
