    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <Card className="p-6 bg-card/80 backdrop-blur-sm border-border">
          ...
          <div className="p-3 rounded-lg bg-success-500/10 border border-success-500/20 mb-4">
            <p style={{ fontSize: "0.8125rem", color: "#22C55E" }}>
              ...
              {smtpSettings.lastTestedAt && (
                <> &middot; {t("settings.smtp.lastTested", { date: new Date(smtpSettings.lastTestedAt).toLocaleDateString(dateLocale()) })}</>
              )}
            </p>
          </div>
        )}
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                type="button"
                aria-label={t(showSmtpPassword ? "common.hidePassword" : "common.showPassword")}
        ...
        <p style={{ fontSize: "0.8125rem", marginTop: "0.75rem" }} className="text-muted-foreground">
          {t("settings.smtp.testConnectionHint")}
        </p>
