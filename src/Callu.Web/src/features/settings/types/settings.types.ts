...
/** Mirrors BE FirebaseSettingsDto (credential JSON is never exposed) */
export interface FirebaseSettingsDto {
    id: string;
    projectId?: string;
...
/** Mirrors BE UpdateFirebaseSettingsRequest */
export interface UpdateFirebaseSettingsRequest {
    projectId?: string;
    serviceAccountJson?: string;
    clearCredential?: boolean;
}

/** Mirrors BE FirebaseTestResult */
