/** Anonymously readable status page showing current service health. */
...
import { useStatusPageBySlug, useSubscribeToStatusPage,
  useRecordStatusPageView, useStatusPageUptime } from '../hooks/use-status-pages';
...
export function PublicStatusPage() {
  ...
  useRecordStatusPageView(page?.id);
