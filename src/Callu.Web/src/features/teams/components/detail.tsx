                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          >
                            <SelectTrigger
                              className={`w-[140px] ${getRoleBadgeClass(member.role)} border`}
                              aria-label={`${t("teams.detail.roleLabel")} — ${member.name}`}
                            >
                              <div className="flex items-center gap-2">
                                <SelectValue />
                              </div>
        ...
        <Dialog open={isAddMemberOpen} onOpenChange={setIsAddMemberOpen}>
          <DialogContent className="bg-card border-border sm:max-w-[600px]">
            ...
            <div className="space-y-5 py-4">
              <div>
                <label htmlFor={`${formId}-new-member`} style={{ fontSize: "0.875rem", fontWeight: 600, marginBottom: "0.5rem", display: "block" }}>
                  {t("teams.detail.userLabel")} <span className="text-error-500">*</span>
                </label>
                <Select value={newMemberId} onValueChange={setNewMemberId}>
                  <SelectTrigger id={`${formId}-new-member`} className="bg-input-background">
