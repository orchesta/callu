...
export const usersApi = {
    ...
    /** Invite a new user. The account is created whether or not the email goes out. */
    invite: (data: InviteUserRequest) =>
        apiClient.post<InvitationResult>(`${BASE}/invite`, data),
    ...
    resendInvitation: (id: string) =>
        apiClient.post<InvitationResult>(`${BASE}/${id}/resend-invitation`),
