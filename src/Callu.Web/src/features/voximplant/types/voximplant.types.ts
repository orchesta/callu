...
export interface VoxCallHistoryQuery {
    fromUtc?: string;
    toUtc?: string;
    count?: number;
    remoteNumber?: string;
...
export interface VoxCallLegDto {
    callId: number;
    localNumber?: string;
    remoteNumber?: string;
    startTime?: string;
...
export interface VoxCallSessionDto {
    callSessionHistoryId: number;
    applicationId: number;
    applicationName?: string;
    startDate?: string;
...
export interface VoxCallHistoryDto {
    totalCount: number;
    timezone: string;
    sessions: VoxCallSessionDto[];
}

export interface VoxSessionLogDto {
    callSessionHistoryId: number;
    content: string;
    truncated: boolean;
}
