// Error hierarchy whose categories mirror the status codes the API's exception
// handler emits.
...
/** Validation errors for one field, matching either camelCase or PascalCase keys. */
