...
export interface TimezonePickerProps {
    ...
    className?: string;
    disabled?: boolean;
    /** Forwarded to the combobox trigger so a visible label can name it; it takes no name from its content. */
    id?: string;
    "aria-label"?: string;
}

export function TimezonePicker({ value, onChange, placeholder = "Select timezone", className, disabled, id, "aria-label": ariaLabel }: TimezonePickerProps) {
